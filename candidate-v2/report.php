...
// Security Check: Candidate can only view their own reports
...
<head>
  ...
  <title>Assessment Report - TruInterview</title>
    ...
    <div class="results-container">
      ...
      <div class="results-header-section">
        <div class="results-header-info">
          ...
          <p>Candidate: <?php echo htmlspecialchars($session['candidate_name']); ?> (<?php echo htmlspecialchars($session['email']); ?>) | Topic: <?php echo htmlspecialchars($templateTitle); ?> | Completed: <?php echo date('M d, Y h:i A', strtotime($session['completed_at'])); ?></p>
        </div>
      </div>
